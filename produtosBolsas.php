...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['acao'])) {
        if ($_POST['acao'] === 'adicionar') {
            ...
            $stmt = $conexao->prepare("INSERT INTO produtos (nome_produto, preco_produto, imagem_produto, id_categoria) VALUES (?, ?, ?, 3)");
...
$resultado = $conexao->query("SELECT * FROM produtos WHERE id_categoria = 3");
...
<head>
    ...
    <title>Portal Abepoli - Itens Portáteis</title>
