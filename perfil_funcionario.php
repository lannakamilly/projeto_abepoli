    ...
    <div class="nav__header">
      ...
      <?php if ($logado): ?>
        <button id="user-icon-mobile" class="user-icon-btn" aria-label="Abrir menu do usuário">
          <img src="<?= htmlspecialchars($foto_src) ?>" alt="Usuário" />
        </button>
      <?php endif; ?>
    </div>
  ...
  <?php if ($logado): ?>
    <div id="user-drawer" class="user-drawer">
      ...
      <div class="user-drawer-content">
        <img src="<?= htmlspecialchars($foto_src) ?>" alt="Foto de perfil" class="user-avatar" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 2px solid #e4af00;">
        <ul class="user-drawer-links">
          <li><a href="./perfil_funcionario.php">Perfil</a></li>
